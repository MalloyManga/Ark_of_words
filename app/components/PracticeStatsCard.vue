...
const { bestCombo, todayProgress } = defineProps<PracticeStatsCardProps>()
</script>

<template>
    <article
        class="mt-10 max-w-xl rounded-4xl border-2 border-emerald-950 bg-[#d7ffe4] p-5 shadow-[9px_9px_0_#86efac] sm:p-6">
